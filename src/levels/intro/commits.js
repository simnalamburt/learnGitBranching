      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              "## Git 커밋",
              "커밋은 Git 저장소에 여러분의 디렉토리에 있는 모든 파일에 대한 스냅샷을 남기는 것입니다. 디렉토리 전체를 복사해 붙여넣는것과 비슷하지만, 훨씬 유용합니다!",
              "",
              "Git은 커밋들의 크기를 가능한한 작게 유지하려고 합니다. 그래서 Git은 커밋을 할 때마다 디렉토리 전체를 복사하는 대신, 소스코드들의 이전 버전과 다음 버전의 변경내역(delta)을 저장합니다.",
              "",
              "또한 Git은 각각의 커밋이 언제 만들어졌는지에 대한 이력을 기록합니다. 그래서 대부분의 커밋들은 자신 위에 부모 커밋을 가지고있습니다 -- 우리는 이를 화살표로 표시할 것입니다. 이력을 남기는것은 프로젝트에서 함께 일하는 사람들 모두에게 아주 좋은 일입니다.",
              "",
              "알아야할 것이 꽤 많습니다만, 일단은 커밋을 프로젝트에 대한 스냅샷으로 이해하셔도 충분합니다. 커밋은 매우 가볍고 커밋 사이의 전환도 매우 빠르다는 것을 기억해주세요!"
            ]
          }
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "연습할 때 어떻게 보이는지 확인해보죠. 오른쪽 화면에 git 저장소를 그림으로 표현해 놓았습니다. 두개의 커밋이 있네요 -- 첫번째 커밋으로 `C0`이 있고, 그 다음으로 코드에 무언가 수정을 주었을 `C1`이라는 커밋이 있네요.",
              "",
              "아래 버튼을 눌러 새로운 커밋을 만들어보세요"
            ],
            "afterMarkdowns": [
              "멋지지 않습니까? 우리는 방금 저장소에 수정을 가해, 이를 한번의 커밋으로 저장했습니다. 방금 만든 커밋의 부모는 `C1`입니다. 부모란 이 커밋이 어떤 커밋을 기반으로 변경된 것인지를 가리킵니다."
            ],
            "command": "git commit",
            "beforeCommand": ""
          }
        },
        {
          ...
          "options": {
            "markdowns": [
              "계속해서 직접 한번 해보세요! 이 창을 닫고, 두번의 커밋을 하시면 다음 단계로 넘어가실 수 있습니다"
            ]
          }
        }
      ]
