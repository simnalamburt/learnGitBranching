      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              "## Git 브랜치",
              "",
              "깃의 브랜치 기능도 놀랍울 정도로 가볍습니다. 브랜치는 특정 커밋을 가리키는 참조(reference)일뿐, 아무것도 아닙니다. 그래서 수많은 Git 예찬론자들은 자주 이렇게 말합니다:",
              "",
              "```",
              "브랜치를 미리미리 자주 만드세요",
              "```",
              "",
              "브랜치를 아무리 많이 만들어도 메모리나 디스크 공간에 부담이 되지 않기 때문에, 여러분의 작업을 커다른 브랜치로 만들기 보다, 작은 단위로 잘게 나누는 것이 좋습니다.",
              "",
        ...
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "브랜치가 어떤 것인지 연습해보죠.",
              "",
              "`newImage`라는 브랜치를 만들어보겠습니다."
            ],
            "afterMarkdowns": [
              "저 그림에 브랜치의 모든 것이 담겨있습니다! 이제 브랜치 `newImage`가 커밋 `C1`를 가리킵니다"
            ],
            "command": "git branch newImage",
            "beforeCommand": ""
          }
